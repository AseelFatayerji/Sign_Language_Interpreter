...
| ---| ---| ---|
| ![fsdaf](./readme/images/Home%20screen.png) | ![fsdaf](./readme/images/Openning%20Screen.png) | ![fsdaf](./readme/images/Learning%20screen.png) |
...
Below were the steps taken to deploy Silent Learning's backend to AWS according to [The Step-by-Step Guide on dev.to](https://dev.to/benchokz/deploying-a-nodejs-app-on-aws-ec2-with-termius-19m4)
